  ...
  <div class="table"> <!-- 页面表格begin -->
    ...
    <div class="container"><!-- 页面内容区begin -->
      <div class="custom-tree-container">
        <div class="block">
          <el-tree :data="treeData" :props="defaultProps" node-key="id" v-loading="listLoading"
        ...
        <el-form :model="addForm" label-width="80px" :rules="formRules" ref="addForm">
          ...
          <el-form-item label="是否有效" prop="validateState">
            <el-select v-model="addForm.validateState" placeholder="请选择">
              <el-option v-for="item in validateStateOptions" :key="item.value" :label="item.label"
                         :value="item.value"></el-option>
            </el-select>
          </el-form-item>
        </el-form>
